import './init.js'
import Vue from 'vue'
import investmentMigrationApp from '@/views/investmentMigration/App.vue'

import VantComponents from '@/config/vant.components.js'
import setDirectives from '@/config/directives.js'
import router from '@/router/investmentMigration/index.js'
import store from '@/store/investmentMigration.js'
...
import { getAccountStatus, nextAfterJudgeAccountStatus } from './init.js'

export { FINANCE_ACCOUNT, FUND_ACCOUNT } from './init.js'
...
const app = new Vue({
    ...
    store,
    i18n,
    render: h => h(investmentMigrationApp),
})
